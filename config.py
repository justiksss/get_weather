...
class Settings:
    ...
    def get_data(self):
        ...
        all_time_info : list = dictionary_with_info.get('hourly').get("time")
        all_time_temperature: list = dictionary_with_info.get('hourly').get("temperature_2m")
        list_time_temperature: list = list(zip(all_time_temperature,all_time_info))
