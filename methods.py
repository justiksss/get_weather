...
class Methods(Settings):
    ...
    def set_coordinates(self):
        self.longitude = float(input("Enter new longitude"))
        self.latitude = float(input("Enter new latitude"))
    ...
    def get_weather(self):
        ...
        response = requests.get(link_to_get_json_from_api).text # dict with all weather >>> json.loads(response)
